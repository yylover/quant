...
class BiasBasicStrategy:
    def __init__(self, data, short_period=6, buy_threshold=-1.5, sell_threshold=1.5, stop_loss=0.08, take_profit=0.20):
        self.data = data.copy()
        ...
        self.output_dir = "/Users/quickyang/Documents/workspace/develop/mycode/quant/sharecode/aklean/tech-factor/bias/bias_basic"
    ...
    def calculate_bias(self):
        ...
        # 识别超买超卖区域
        self.data['oversold'] = self.data['bias_short']< self.buy_threshold
        self.data['overbought'] = self.data['bias_short'] >self.sell_threshold
    ...
    def generate_signals(self):
        ...
        # 买入信号：短期BIAS超卖
        self.data.loc[self.data['oversold'], 'signal'] = 1
        
        # 卖出信号：短期BIAS超买
        self.data.loc[self.data['overbought'], 'signal'] = -1
    ...
    def plot_results(self):
        ...
        plt.tight_layout()
        plt.savefig(f"{self.output_dir}/bias_basic_strategy_backtest.png", dpi=300, bbox_inches='tight')
        plt.close()
...
if __name__ == "__main__":
    ...
    # 创建策略实例
    strategy = BiasBasicStrategy(data, buy_threshold=-2.5, sell_threshold=3.5)
