...
# - 策略逻辑 ：基于20日和60日均线交叉，结合长期均线斜率确认趋势
# - 买入信号 ：短期均线上穿长期均线，且长期均线斜率为正
# - 卖出信号 ：短期均线下穿长期均线，且长期均线斜率为负
# 回测结果：
...
def main():
    ...
    try:
        ...
        # 使用固定参数运行回测（20日均线和60日均线）
        system = TrendTradingSystem(data.copy(), short_window=20, long_window=60)
        system.run()
